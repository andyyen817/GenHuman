...
/**
 * Vidspark數據庫初始化腳本
 * 訪問地址：https://genhuman-digital-human.zeabur.app/vidspark-database-init.php
 * 
 * 功能：在現有genhuman_db中創建Vidspark專用表
 * 創建日期：2025-08-29
 * 版本：v1.0
 */
    ...
    $createTableQueries = [
        ...
        'vidspark_production_tasks' => "
            CREATE TABLE IF NOT EXISTS vidspark_production_tasks (
                ...
                FOREIGN KEY (user_id) REFERENCES vidspark_production_users(id) ON DELETE CASCADE,
        ...
        'vidspark_production_files' => "
            CREATE TABLE IF NOT EXISTS vidspark_production_files (
                ...
                FOREIGN KEY (task_id) REFERENCES vidspark_production_tasks(id) ON DELETE CASCADE,
                FOREIGN KEY (user_id) REFERENCES vidspark_production_users(id) ON DELETE CASCADE,
...
echo "
        ...
        <p style='text-align: center; color: #666; margin-top: 30px;'>
            <strong>Vidspark數據庫初始化腳本 v1.0</strong><br>
            創建日期：2025年8月29日 | 
