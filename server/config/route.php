...
// 🆕 Vidspark v2.0 管理後台路由（独立版本）
Route::get('/vidspark-v2/admin/i18n-manager-standalone.html', function () {
    $filePath = base_path() . '/public/vidspark-v2/admin/i18n-manager-standalone.html';
    if (file_exists($filePath)) {
        return (new Response(200, [
            'Content-Type' => 'text/html; charset=utf-8',
            'Cache-Control' => 'no-cache, no-store, must-revalidate'
    ...
    return new Response(404, ['Content-Type' => 'text/plain'], 'I18n standalone manager not found');
});
