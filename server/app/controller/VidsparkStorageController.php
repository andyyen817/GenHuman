...
class VidsparkStorageController
{
     ...
     * 快速數據庫初始化
     */
    public function quickDbInit(Request $request): Response
    {
        $response = [
            'success' => false,
            'message' => '',
        ...
        try {
            ...
            // 創建存儲目錄
            $storageDirectories = [
                base_path() . '/public/vidspark/storage/video/2025/08',
                base_path() . '/public/vidspark/storage/audio/2025/08',
                base_path() . '/public/vidspark/storage/images/2025/08'
            ];
