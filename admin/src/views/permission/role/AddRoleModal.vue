  ...
  <a-modal v-model:visible="visible" :title="title" width="90%" :mask-closable="false"
    ...
    <a-form ref="formRef" :model="form" :rules="rules" size="medium" auto-label-width>
      <a-form-item label="角色名称" field="title">
        <a-input v-model.trim="form.title" placeholder="请输入角色名称" allow-clear > </a-input>
      </a-form-item>
      <a-form-item label="角色编码" field="code">
        <a-input v-model.trim="form.code" placeholder="请输入角色编码" allow-clear :disabled="isEdit" >
        </a-input>
      </a-form-item>
...
import { getRoleDetail, saveRole } from '@/apis/permission'
