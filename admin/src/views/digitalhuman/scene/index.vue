<template>
    <a-card title="场景分身" class="gi_page_card">
        ...
        <a-table class="gi_table" row-key="id" :data="roleList" :bordered="{ cell: true }" :loading="loading"
            ...
            <template #columns>
                ...
                <a-table-column title="分身名称" data-index="title"></a-table-column>
                ...
                <a-table-column title="场景ID" data-index="scene_id" :ellipsis="true" :tooltip="true"></a-table-column>
...
import { getSceneList, deleteScene } from '@/apis/digitalhuman'
...
const {
    ...
    searchParams,
    reset
} = useTable((page) => getSceneList(page), { immediate: true })
